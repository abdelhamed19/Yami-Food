 <!-- Start header -->
 <x-front-header title="Edit Reservation" />
 <br>
                     ...
                     <form action="{{ route('reservation.update', $reservation->id) }}" method="POST">
                         ...
                         <div class="row">
                             <div class="col-md-6">
                                 ...
                                 <div class="col-md-12">
                                     <div class="form-group">
                                         <input type="time" name="reserve[time]"
                                             class="time form-control picker__input" value="{{ $reservation->time }}"
                                             required data-error="Please enter time">
                                         <div class="help-block with-errors"></div>
                                     </div>
                                     <div class="form-group">
                                         <input type="text" name="reserve[notes]"
                                             class="time form-control picker__input" value="{{ $reservation->notes }}"
                                             required data-error="Please enter time">
                                         <div class="help-block with-errors"></div>
                                     </div>
                                 </div>
                             ...
                             @else
                                 ...
                                 <div class="col-md-6">
                                     ...
                                     <div class="col-md-12">
                                         <div class="form-group">
                                             <input type="text" name="reserve[name]" class="form-control"
                                                 id="name" value="{{ $reservation->name }}" placeholder="Your Name"
