        ...
        <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown"
                    data-toggle="dropdown" aria-expanded="false" href="#">+ Add new Admins</a>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                    <div class="navbar-profile">
                        <img class="img-xs rounded-circle" src='{{ asset("assets/dashboard/images/faces/face15.jpg") }}'
                            alt="">
                        <p class="mb-0 d-none d-sm-block navbar-profile-name">{{ Auth::guard('admins')->user()->name }} </p>
